...
public class StatusResponseTranslatorTest {
	...
	public void dado_uma_string_de_status_deve_traduzir_para_mapa() throws UnreadableMessageException {
		...
		Map<ServerStatusType, String> translate = StatusResponseTranslator.translate(successServerMessage.getBytes());
	...
	public void dado_uma_string_de_info_deve_traduzir_para_mapa() throws UnreadableMessageException {
		...
		Map<ServerStatusType, String> translate = StatusResponseTranslator.translate(successInfoMessage.getBytes());
