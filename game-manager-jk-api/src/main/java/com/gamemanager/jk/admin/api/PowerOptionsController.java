...
public class PowerOptionsController {
	...
	@GetMapping("poweron")
	public String poweron(@AuthenticationPrincipal UserEntity user,
	...
	@GetMapping("poweroff")
	public String poweroff(@AuthenticationPrincipal UserEntity user,
						   RedirectAttributes attributes) {
	...
	@GetMapping("restart")
	public String restart(@AuthenticationPrincipal UserEntity user,
						  RedirectAttributes attributes) {
